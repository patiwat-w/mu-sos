...
import './AimAssessmentPage.module.css'; // CSS Module
...
const AimAssessmentPage: React.FC = () => {
  ...
  const [activeButton, setActiveButton] = useState<string>('Aim'); // State to track active button
...
export default AimAssessmentPage;